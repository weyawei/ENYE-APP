...
class productSubCarousel extends StatefulWidget {
  final List<product> products;
  const productSubCarousel({
    super.key,
    required this.products,
  });

  @override
  State<productSubCarousel> createState() => _productSubCarouselState();
}

class _productSubCarouselState extends State<productSubCarousel> {
