...
class HistoryViewPage extends StatefulWidget {
  ...
  const HistoryViewPage({super.key, required this.events, required this.tsis, required this.service});
                          ...
                          if (serviceOrder.tsis_id == widget.tsis.tsis_id && serviceOrder.event_id == event.id) {
                            return Padding(
                              ...
                              child: ElevatedButton(
                                ...
                                style: ButtonStyle(
                                  backgroundColor: MaterialStateProperty.all<Color>(Colors.deepOrange.shade300),
