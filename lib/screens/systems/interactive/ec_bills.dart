...
class ECBillsPage extends StatefulWidget {
  @override
  _ECBillsPageState createState() => _ECBillsPageState();
}

class _ECBillsPageState extends State<ECBillsPage> with TickerProviderStateMixin {
          ...
          child: Column(
            children: [
              SizedBox(
                ...
                height: MediaQuery.of(context).size.width * 0.7,
                child: ModelViewer(
                  src: 'assets/systems/ec_bills/woltman_watermeter.glb',
                  ar: true,
                  autoRotate: true,
                  cameraControls: true,
                ),
              ...
              Text(
                "Hybrid Digital Woltmann Water Meter",
                style: TextStyle(
                  fontSize: MediaQuery.of(context).size.width * 0.035,
                  letterSpacing: 0.8,
                  fontWeight: FontWeight.bold,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("ENYECONTROLS BILLING SYSTEM"),
              ...
              Expanded(
                child: InteractiveViewer(
                  ...
                  child: Stack(
                    children: [
                      Image.asset(
                        'assets/systems/ec_bills/ec_bills.png',
                ...
                // GestureDetector for Product 3
                      ...
                      Positioned(
                        ...
                        top: MediaQuery.of(context).size.height * 0.24, // Adjusted for relative positioning
                        width: MediaQuery.of(context).size.width * 0.07, // Relative size
                        height: MediaQuery.of(context).size.height * 0.04, // Relative size
                        child: GestureDetector(
                          onTap: () {
                      ...
                      Positioned(
                        ...
                        top: MediaQuery.of(context).size.height * 0.335, // Adjusted for relative positioning
                        width: MediaQuery.of(context).size.width * 0.07, // Relative size
                        height: MediaQuery.of(context).size.height * 0.04, // Relative size
                        child: GestureDetector(
                          onTap: () {
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        IconButton(
                          icon: Image.asset(
                            'assets/systems/ec_bills/woltman.png',
                            height: 150,
                            fit: BoxFit.fill,
                          ),
                          iconSize: 80,
                          onPressed: () {
                            _zoomToProduct(
                              ...
                              Offset(MediaQuery.of(context).size.width * 0.05, MediaQuery.of(context).size.height * 0.23),
                              Offset(MediaQuery.of(context).size.width * -0.01, MediaQuery.of(context).size.height * 0.07),
                                  () => _showProduct3Details(context),
                            );
                            /*  _zoomToProduct(
                        ...
                        IconButton(
                          ...
                          onPressed: () {
                            _zoomToProduct(
                              ...
                              Offset(MediaQuery.of(context).size.width * 0.2, MediaQuery.of(context).size.height * 0.23),
                              Offset(MediaQuery.of(context).size.width * -0.01, MediaQuery.of(context).size.height * 0.07),
                                  () => _showProduct4Details(context),
                            );
                            /*  _zoomToProduct(
