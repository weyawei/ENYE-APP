...
class WaterSystemPage extends StatefulWidget {
  @override
  _WaterSystemPageState createState() => _WaterSystemPageState();
}

class _WaterSystemPageState extends State<WaterSystemPage> with TickerProviderStateMixin {
          ...
          child: Column(
            children: [
              SizedBox(
                ...
                height: MediaQuery.of(context).size.width * 0.7,
                child: ModelViewer(
                  src: 'assets/systems/water/water_detector.glb',
                  ar: true,
                  autoRotate: true,
                  cameraControls: true,
                ),
          ...
          child: Column(
            children: [
              SizedBox(
                ...
                height: MediaQuery.of(context).size.width * 0.7,
                child: ModelViewer(
                  src: 'assets/systems/water/tape_sensor.glb',
                  ar: true,
                  autoRotate: true,
                  cameraControls: true,
                ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text("Water Leak Detection and Alarm System"),
...
//
                    Column(
                      children: [
                        IconButton(
                          icon: Image.asset(
                            'assets/systems/water/water_leak_sensor.png',
                            height: 150,
                            fit: BoxFit.fill,
                          ),
                          iconSize: 80,
                    ...
                    Column(
                      children: [
                        IconButton(
                          icon: Image.asset(
                            'assets/systems/water/sensor_tape.png',
                            height: 150,
                            fit: BoxFit.fill,
                          ),
                          iconSize: 80,
